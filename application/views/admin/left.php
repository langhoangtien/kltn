...
<ul id="menu" class="nav">
		<li class="product">
			<a href="admin/Historypaid" class="exp inactive">
				<span>Quản lý hồ sơ</span>
				<strong>3</strong>
			</a>
			<ul class="sub" style="display: none;">
					<li>
						<a href="<?php echo admin_url('Historypaid')?>">Hồ sơ </a>
					</li>
					
					<li>
						<a href="<?php echo admin_url('Historypaid/add')?>">Thêm mới hồ sơ  </a>
					</li>
			</ul>
		...
		<li class="product">
			...
			<ul class="sub" style="display: none;">
					<li>
						<a href="<?php echo admin_url('category')?>">Sản phẩm</a>
					</li>
		...
		<li class="product">
			...
			<a href="admin/tran.html" class="exp inactive">
				<span>Quản lý lãi suất</span>
				<strong>2</strong>
			</a>
			
					<ul class="sub" style="display: none;">
						<li>
									<a href="<?php echo admin_url('history_interestrate')?>">Quản lý lãi suất</a>
							</li>
							<li>
								<a href="admin/product_order.html">Quan ly san pham</a>
							</li>
							</ul>
						
					</li>
			<li class="product">
				<a href=<?php echo admin_url('attribute') ?> class="exp inactive">
					<span>Quản lý thuộc tính </span>
					<strong></strong>
				</a>
				<ul class="sub" style="display: none;">
						<li>
							<a href="<?php echo admin_url('attribute/index')?>">Thuộc tính</a>
						</li>
